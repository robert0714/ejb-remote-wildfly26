...
abstract class AbstractSpanImpl implements Span {
    ...
    AbstractSpanImpl( Object span) {
        this.span = span;
        initialize(span);
    }

    private void initialize( Object span) {
    ...
    private void doSetTypes(Object span, String type,  String subtype,  String action) {
